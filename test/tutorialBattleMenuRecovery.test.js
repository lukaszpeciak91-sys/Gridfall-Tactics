...
test('lifecycle recovery still normalizes UI and refreshes banners without taking mulligan ownership', () => {
...
test('fullscreen recovery remains independent from utility navigation and mulligan state', () => {
