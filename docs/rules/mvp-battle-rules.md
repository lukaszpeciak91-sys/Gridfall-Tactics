...
| Control | Sniper | unit | 2/1/0 | on_deploy_damage_enemy_unit_2 | On deploy choose any [ENEMY] and deal damage | One enemy unit on deploy | Remains deployed; standard combat uses its opposing lane. |
