...
| Attrition Swarm | Feast | utility | - | destroy_friendly_damage_enemy_base_1 | Destroy [ALLY]. Enemy base loses 1 HP. | Targeted friendly | Non-combat destruction plus enemy base damage; does not trigger combat-only death effects. |
