...
- Fixed BattleScene vertical scaling with strict safe-area zone stacking (8/50/7/7/23/5) so hand, deck, and tip bar remain fully visible across viewport heights.
