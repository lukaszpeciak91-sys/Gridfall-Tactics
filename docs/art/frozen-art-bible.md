...
**Production premise:** Treat this faction as late-1980s Eastern Bloc agricultural industry redirected into a state agricultural/military breeding program. Its world is industrial livestock, government breeding facilities, veterinary laboratories, feed silos, industrial barns, agricultural machinery, and official procedures that keep running after humanity disappears. The horror comes from obedient process, quota logic, inspections, and state paperwork treating catastrophe as successful agricultural output; it is not rebellion, evil magic, rogue AI, or malfunction.

**Animal design rules:** P.A.S.Z.A. animals are biological military products and evaluated specimens, not characters. They do not speak, pose heroically, behave like mascots, or read as pets. The recognizable domestic-animal silhouette must be the first read: hare, hog, ox, ram, or herd specimen before gear. Equipment, ear tags, rubber tubing, restraint frames, veterinary fittings, and farm machinery must support the animal body rather than replace it. Military adaptation comes from breeding, veterinary surgery, conditioning, and agricultural engineering. Avoid robot limbs, sci-fi exosuits, cybernetic plating, futuristic prosthetics, sleek armor shells, or hero-character framing.

**Material and palette lock:** Preserve the dirty agricultural palette: feed yellow, warm milk white, dirty cream, faded straw, industrial orange, chipped enamel, weathered concrete, black rubber, flesh pink biological accents, and dark asphalt navy only as a minor dark contrast. Preferred materials and props are animal tags, plastic ear tags, plastic agricultural equipment, livestock gates/chutes, feed troughs, silos, barns, veterinary surfaces, rubber hoses, concrete stalls, enamel-painted machinery, and heavy agricultural equipment. Keep surfaces handled, scuffed, institutional, and farm-industrial rather than polished, glassy, or futuristic.

**Tone and humor:** The tone is bureaucratic horror and deadpan institutional absurdity. The comedy comes from procedure, forms, quotas, inspections, stamped approvals, and official normalcy documenting biological disaster as agricultural success. Do not use meme humor, wink-to-camera jokes, cute animal comedy, or "haha animal with weapon" framing. The state apparatus should appear sincerely confident that the program is normal, useful, and productive.

**Banner-specific rules:** The banner's dominant read should be an official livestock-program mark, animal handling apparatus, feed silo, veterinary restraint silhouette, or concrete breeding facility. Do not bake readable faction names, program names, letters, UI text, form text, numbers, or logos into the artwork. If a mark or emblem appears, it must be non-readable, symbolic, and subordinate to the poster read. Avoid heroic animal mascot poster treatment. Keep the banner institutional, agricultural, and official rather than logo-forward, and preserve readability under the existing faction-banner crop rules.

**Unit-card rules:** The five unit subjects should stay recognizably domestic: **Decoy Hare / Zając Wabik**, **Suppressor Hog / Wieprz Tłumiący**, **Single-Use Ox / Wół Jednorazowy**, **Breach Ram / Baran Wyłomowy**, and **Central Specimen / Sztuka Centralna**. For every unit card, prioritize animal silhouette first, biological/agricultural adaptation second, and setting/context third. Avoid heroic posing, speaking or expressive character acting, pet/mascot framing, robot or cyberpunk interpretation, and equipment-dominant creature design. A good unit image should feel like an official archive photograph or classified agricultural documentation of a dangerous state-bred specimen.

**Effect-card rules:** Effect art should show procedures rather than magic: quotas, reassignment, penetration/breach tests, conditioning cues, temperament correction, veterinary handling, livestock gates/chutes, unreadable forms and inspection marks, restraint stalls, feed machinery, and production-line staging. Avoid abstract magic, hacking UI, sci-fi neural control, glowing cyberpunk tech, glass-tube laboratories, and Orden-like glass/neural/signal motifs.

**Separation from Orden der Glasköpfe:** P.A.S.Z.A. is warm dirty agricultural bureaucracy: biological livestock, enamel, rubber, concrete, feed, barns, veterinary handling, state farm horror, and official livestock production. Orden der Glasköpfe is glass heads, neural cables, signal towers, machine theology, cold technocracy, glass cylinders, optics, and signal infrastructure. P.A.S.Z.A. labs must feel veterinary/agricultural, not techno-occult. Use no glass aesthetics, no signal towers, no heads in jars, and no neural-cable mysticism.
...
- **Project H.E.R.D. / Program P.A.S.Z.A.:** `late Eastern Bloc agricultural industry, industrial livestock, state breeding program, veterinary labs, feed silos, concrete barns, animal ear tags, rubber tubing, chipped enamel, feed yellow, warm milk white, dirty cream, straw, industrial orange, bureaucratic horror, deadpan official absurdity, biological military livestock, no cyberpunk, no robots, no neon, no glass aesthetics, no signal towers, animals as products not characters`
