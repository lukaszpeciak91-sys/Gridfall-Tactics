...
const HAND_CARD_BODY_LINE_SPACING = 2;
...
const INSPECT_CARD_BODY_LINE_SPACING = 4;
const HAND_CARD_INSPECT_DIM_ALPHA = 0.55;
const HAND_CARD_LONG_PRESS_MS = 425;
const CARD_RULES_TEXT_TOP_PADDING_RATIO_COMPACT = 0.075;
const CARD_RULES_TEXT_BOTTOM_PADDING_RATIO_COMPACT = 0.085;
