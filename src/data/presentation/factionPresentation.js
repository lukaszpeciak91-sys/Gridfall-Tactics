...
const presentation = {
  aggro: {
    ...
    shortConcept: 'A powdered aristocracy of cracked porcelain automata and frenzied nobles turns etiquette into televised ballroom violence.',
    tone: 'Decadent, theatrical, elegant, psychotic, and darkly comic.',
    styleTags: [
      'rococo chaos',
    ...
    cardNameOverrides: {
      ...
      aggro_berserker_1: { nameEn: 'Frenzied Noble', namePl: 'Rozszalały Arystokrata' },
      aggro_glass_cannon_1: { nameEn: 'Porcelain Golem', namePl: 'Porcelanowy Golem' },
      aggro_flanker_1: { nameEn: 'Frenzied Marquis', namePl: 'Rozszalały Markiz' },
      aggro_scout_1: { nameEn: 'Tea Courier', namePl: 'Herbaciany Kurier' },
      aggro_full_attack_1: { nameEn: 'Grand Banquet', namePl: 'Wielka Uczta' },
      aggro_rush_1: { nameEn: 'Mad Waltz', namePl: 'Szalony Walc' },
      ...
      aggro_quick_fix_1: { nameEn: 'Violent Courtesy', namePl: 'Brutalna Uprzejmość' },
    },
  },
  control: {
    ...
    cardNameOverrides: {
      control_hacker_1: { nameEn: 'Signal Officer', namePl: 'Oficer Sygnałowy' },
      control_disruptor_1: { nameEn: 'Disruption Vessel', namePl: 'Jednostka Zakłócająca' },
      control_sniper_1: { nameEn: 'Precision Drone', namePl: 'Dron Precyzyjny' },
      control_controller_1: { nameEn: 'Neural Controller', namePl: 'Kontroler Neuralny' },
      control_drone_1: { nameEn: 'Glass Probe', namePl: 'Szklana Sonda' },
      control_swap_1: { nameEn: 'Tactical Relocation', namePl: 'Relokacja Taktyczna' },
      control_jam_signal_1: { nameEn: 'Jam Signal', namePl: 'Sygnał Zagłuszający' },
      control_pulse_wave_1: { nameEn: 'Pulse Wave', namePl: 'Fala Impulsowa' },
      control_system_override_1: { nameEn: 'System Override', namePl: 'Przejęcie Systemu' },
      control_recall_1: { nameEn: 'Retrieval Protocol', namePl: 'Protokół Odzysku' },
    },
  },
  swarm: {
  ...
  tank: {
    ...
    cardNameOverrides: {
      tank_shieldbearer_1: { nameEn: 'Sunscale Guardian', namePl: 'Strażnik Słonecznej Łuski' },
      tank_heavy_1: { nameEn: 'Imperial Goliath', namePl: 'Imperialny Goliat' },
      tank_guardian_1: { nameEn: 'Golden Sentinel', namePl: 'Złoty Strażnik' },
      tank_wall_1: { nameEn: 'Obsidian Bulwark', namePl: 'Obsydianowy Bastion' },
      tank_bruiser_1: { nameEn: 'Crestfang Veteran', namePl: 'Weteran Grzebieniastego Kła' },
      tank_fortify_1: { nameEn: 'Solar Fortification', namePl: 'Solarne Umocnienie' },
      tank_stability_1: { nameEn: 'Imperial Stability', namePl: 'Imperialna Stabilność' },
      tank_reinforce_1: { nameEn: 'Sacred Reinforcements', namePl: 'Święte Wzmocnienia' },
      tank_last_stand_1: { nameEn: 'Last Dynasty', namePl: 'Ostatnia Dynastia' },
      tank_repair_kit_1: { nameEn: 'Reactive Carapace', namePl: 'Reaktywny Karapaks' },
    },
  },
  wardens: {
    displayNameEn: 'Mammoth Riders',
    displayNamePl: 'Jeźdźcy Mamutów',
    ...
    cardNameOverrides: {
      ...
      wardens_spearwall_1: { nameEn: 'Spearwall Hunter', namePl: 'Łowca Włóczniowej Ściany' },
      wardens_halberdier_1: { nameEn: 'Tundra Halberdier', namePl: 'Halabardnik Tundry' },
      wardens_bastion_guard_1: { nameEn: 'Bastion Keeper', namePl: 'Strażnik Bastionu' },
      wardens_watch_captain_1: { nameEn: 'Watch Chieftain', namePl: 'Wódz Straży' },
      wardens_brace_1: { nameEn: 'Brace the Line', namePl: 'Umocnić Linię' },
      wardens_shield_push_1: { nameEn: 'Mammoth Charge', namePl: 'Mamucia Szarża' },
      wardens_stand_firm_1: { nameEn: 'Frozen Resolve', namePl: 'Lodowa Determinacja' },
      wardens_reinforce_line_1: { nameEn: 'Reinforce the Wall', namePl: 'Wzmocnić Mur' },
      wardens_hold_the_line_1: { nameEn: 'Hold the Pass', namePl: 'Utrzymać Przełęcz' },
    },
  },
};
