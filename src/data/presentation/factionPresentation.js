...
const presentation = {
  ...
  overclock: {
    ...
    cardNameOverrides: {
      ...
      overclock_gap_hunter_1: { name: { en: 'Breach Ram', pl: 'Baran Wyłomowy', uk: 'Баран-таран' } },
      overclock_mob_champion_1: { name: { en: 'Command Hen', pl: 'Kwoka Dowodząca', uk: 'Командна квочка' } },
