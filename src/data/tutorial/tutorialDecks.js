  ...
  deck: [
    {
      ...
      artAssetId: 'ally_01',
      name: 'Sweeper',
      localizedName: { en: 'Sweeper', pl: 'Zamiatacz' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
    ...
    },
    {
      ...
      artAssetId: 'ally_02',
      name: 'Scrap Cart',
      localizedName: { en: 'Scrap Cart', pl: 'Kolaska' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
    ...
    },
    {
      ...
      artAssetId: 'ally_03',
      name: 'Dozer',
      localizedName: { en: 'Dozer', pl: 'Spychacz' },
      type: 'unit',
      targeting: 'lane',
    ...
    },
    {
      ...
      name: 'Alarm Siren',
      localizedName: { en: 'Alarm Siren', pl: 'Syrena Alarmowa' },
      type: 'order',
      targeting: 'all_friendly_units',
      effectId: 'buff_all_atk_1',
      textShort: 'All [ALLIES] +1 ATK until combat',
      localizedTextShort: { en: 'All [ALLIES] +1 ATK until combat', pl: '[ALLIES] +1 ATK do walki' },
    },
    {
      ...
      name: 'Mop Bot',
      localizedName: { en: 'Mop Bot', pl: 'Mop Bot' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 0,
