  ...
  deck: [
    {
      ...
      localizedName: { en: 'Rejected Contestant', pl: 'Odrzucony Uczestnik' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
    ...
    },
    {
      ...
      artAssetId: 'enemy_02',
      name: 'Test Dummy',
      localizedName: { en: 'Test Dummy', pl: 'Manekin Testowy' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
    ...
    },
    {
      ...
      artAssetId: 'enemy_03',
      name: 'Fan Mascot',
      localizedName: { en: 'Fan Mascot', pl: 'Pluszak' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
    ...
    },
    {
      ...
      artAssetId: 'enemy_04',
      name: 'Stray Fan',
      localizedName: { en: 'Stray Fan', pl: 'Zbłąkany Kibic' },
      type: 'unit',
      targeting: 'lane',
      textShort: '',
      attack: 1,
