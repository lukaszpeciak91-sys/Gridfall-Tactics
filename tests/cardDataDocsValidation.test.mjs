...
const expectedTextShort = new Map(Object.entries({
  ...
  swarm_recycle_1: 'Enemies get -1 ARM this combat.',
  ...
  wardens_shield_push_1: 'Swap two adjacent enemies. They get -1 ATK this combat.',
  ...
  attrition_swarm_feast_1: 'Destroy an ally. Enemy base loses 1 HP.',
