...
test('tutorial card display names resolve in English and Polish', () => {
  ...
  const expectedNames = {
    ...
    tutorial_mulligan_bait_1: { en: 'Mop Bot', pl: 'Mop Bot' },
    tutorial_filler_guard_1: { en: 'Mop Bot', pl: 'Mop Bot' },
    tutorial_filler_guard_2: { en: 'Mop Bot', pl: 'Mop Bot' },
    tutorial_filler_sentinel_1: { en: 'Mop Bot', pl: 'Mop Bot' },
    tutorial_filler_scout_1: { en: 'Mop Bot', pl: 'Mop Bot' },
    tutorial_filler_recruit_1: { en: 'Mop Bot', pl: 'Mop Bot' },
