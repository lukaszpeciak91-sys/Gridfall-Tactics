...
test('battle utility menu opens panel actions and rules resume the existing scene', () => {
  ...
  assert.match(battleSource, /const panelLeft = Phaser\.Math\.Clamp\(triggerX - touchSize \/ 2, margin, width - margin - panelWidth\);[\s\S]*const panelX = panelLeft \+ panelWidth \/ 2;/);
