...
test('polished card text stays within mobile collection and inspect rules panels', () => {
  const cardCases = [
    ...
    { factionKey: "Control", cardId: "control_sniper_1", locale: "en", expectedBody: "On deploy: choose any ♟ and deal 2 damage" },
    { factionKey: "Control", cardId: "control_sniper_1", locale: "pl", expectedBody: "Przy wystawieniu: wybierz dowolnego ♟ i zadaj 2 ●" },
