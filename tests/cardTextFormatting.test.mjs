...
test('formats HP-related healing and damage language without replacing unrelated numbers', () => {
  ...
  assert.equal(formatCardEffectTextShort('First 2 [ALLY] combat deaths: deal 1 to opposed enemy.', 'en'), 'First 2 ♙ combat deaths: deal 1 ● to opposed enemy.');
  ...
  assert.equal(formatCardEffectTextShort('Pierwsze 2 śmierci [ALLY] w walce: zadaj 1 wrogowi naprzeciw.', 'pl'), 'Pierwsze 2 śmierci ♙ w walce: zadaj 1 ● wrogowi naprzeciw.');
  assert.equal(formatCardEffectTextShort('Zniszcz [ALLY]. Dobierz 1.', 'pl'), 'Zniszcz ♙. Dobierz 1.');
  assert.equal(formatCardEffectTextShort('Śmierć w walce: przywołaj tu 1/1.', 'pl'), 'Śmierć w walce: przywołaj tu 1/1.');
});
